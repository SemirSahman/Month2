...
/**
 * This class represents a Card from a standard deck The values go from 1 to 13
 * 11 - Jack 12 - Queen 13 - King Suits go from 0 - 3 0 - Hearts 1 - Diamonds 2
	...
	public void setValue(int value) {
		if (isJoker == false) {
			throw new UnsupportedOperationException(
					"Cant change the value of a non Joker card");
		}
		if (value < MIN_VALUE || value > MAX_VALUE) {
			throw new IllegalArgumentException("Value must be in range 1 to 13");
		}
